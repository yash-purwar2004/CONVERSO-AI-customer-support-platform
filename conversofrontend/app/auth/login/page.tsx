  ...
  return (
    <div className="min-h-screen bg-zinc-950 flex">
      ...
      <div className="hidden lg:flex w-1/2 relative bg-yellow-400 flex-col justify-between p-12 overflow-hidden">
        ...
        {/* Big number */}
        <div
          className="absolute -bottom-10 -left-6 text-[22rem] font-black leading-none text-black/10 select-none"
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-20 py-16 relative">
        {/* Corner decorations */}
        <div className="absolute top-0 right-0 w-32 h-32 border-b border-l border-zinc-800" />
        <div className="absolute bottom-0 left-0 w-32 h-32 border-t border-r border-zinc-800" />
        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form onSubmit={handleSubmit} className="space-y-0">
            {fields.map(({ name, label, type, placeholder }, i) => (
              <div key={name}>
                <div
                  className={`border-t pt-4 pb-4 transition-all duration-200 ${
            ...
            {/* Forgot password */}
            <div className="border-t border-zinc-800 pt-4 pb-6 flex justify-end">
              <a
                href="/forgot-password"
                className="text-[10px] font-mono tracking-[0.2em] uppercase text-zinc-600 hover:text-yellow-400 transition-colors"
              >
                Forgot password?
              </a>
            </div>
